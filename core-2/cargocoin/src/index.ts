...
const tokenName = "cargocoin";
const tokenSymbol = "CARGO";
const description = "coin based on rust package manager";
const decimals = 4;
const amount = 1000;
...
async function main() {
  ...
  const buffer = fs.readFileSync("./assets/cargo.png");
  const file = toMetaplexFile(buffer, "cargo.png");
