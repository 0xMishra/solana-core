...
async function createTokenMetadata(
  ...
  // file to buffer
  const buffer = fs.readFileSync("assets/pizza.jpg");

  // buffer to metaplex file
  const file = toMetaplexFile(buffer, "pizza.jpg");
...
// BoyPAJABjDkPqZHfNJqEtniiN1d96ZuPJePyTwB5mshy
async function main() {
  ...
  const MINT_ADDRESS = "BoyPAJABjDkPqZHfNJqEtniiN1d96ZuPJePyTwB5mshy";
  // metaplex setup
